...
function Avatar$1(_ref) {
    ...
    var className = classNames(styles$1.Avatar, styles$1[variationName('style', styleClass(nameString))], size && styles$1[variationName('size', size)]);
    var imageMarkUp = finalSource ? createElement(Image$1, { className: styles$1.Image, source: finalSource, alt: '', role: 'presentation' }) : null;
    var initialsMarkup = initials ? createElement(
        'span',
...
function Icon$1(_ref) {
    ...
    var className = classNames(styles$2.Icon, color && styles$2[variationName('color', color)], backdrop && styles$2.hasBackdrop);
...
function ButtonGroup$1(_ref) {
    ...
    var className = classNames(styles$5.ButtonGroup, segmented && styles$5.segmented);
    var contents = elementChildren(children).map(function (child, index) {
        return createElement(Item, { button: child, key: index });
    });
    return createElement(
        'div',
        { className: className },
...
function Item$2(_ref) {
    ...
    var className = classNames(styles$6.Item, fill && styles$6['Item-fill']);
    return createElement(
        'div',
        { className: className },
        children
...
var Stack$1 = function (_React$PureComponent) {
    ...
    _createClass(Stack, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$6.Stack, vertical && styles$6.vertical, spacing && styles$6[variationName('spacing', spacing)], distribution && styles$6[variationName('distribution', distribution)], alignment && styles$6[variationName('alignment', alignment)], wrap === false && styles$6.noWrap);
...
function Header(_ref) {
  ...
  var actionMarkup = actions ? createElement(
    ButtonGroup$1,
    null,
    buttonsFrom(actions, { plain: true })
  ) : null;
  var headingMarkup = actionMarkup ? createElement(
    Stack$1,
    { alignment: 'baseline' },
    createElement(
      Stack$1.Item,
...
function Section(_ref) {
    ...
    var headerContent = title ? createElement(
        'div',
    ...
    var className = classNames(styles$8.Section, subdued && styles$8['Section-subdued']);
    return createElement(
        'div',
        { className: className },
        headerContent,
...
var Card$1 = function (_React$PureComponent) {
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$8.Card, subdued && styles$8.subdued);
            var headerMarkup = title ? createElement(
                Header,
                { actions: actions },
                title
            ) : null;
            var content = sectioned ? createElement(
                Section,
                null,
                children
            ) : children;
            ...
            var footerMarkup = primaryFooterActionMarkup || secondaryFooterActionMarkup ? createElement(
                'div',
...
function TextStyle$1(_ref) {
    ...
    var className = classNames(variation && styles$11[variationName('variation', variation)]);
    return createElement(
        'span',
        { className: className },
        children
...
function AccountConnection$1(_ref) {
    ...
    var avatarMarkup = connected ? createElement(Avatar$1, { accessibilityLabel: '', name: accountName, initials: initials, source: avatarUrl }) : null;
    ...
    var detailsMarkup = details ? createElement(
        'div',
        null,
        createElement(
            TextStyle$1,
    ...
    var termsOfServiceMarkup = termsOfService ? createElement(
        'div',
...
function Item$3(_ref) {
    ...
    var className = classNames$1(styles$13.Item, disabled && styles$13.disabled);
    ...
    var contentElement = imageElement ? createElement(
        'div',
...
function Section$1(_ref) {
    ...
    var actionMarkup = section.items.map(function (_a) {
        ...
        return createElement(Item$3, Object.assign({ key: content, content: content, onAction: handleAction(onAction) }, item));
    });
    var className = section.title ? null : styles$13['Section-withoutTitle'];
    var titleMarkup = section.title ? createElement(
        'p',
        { className: styles$13.Title },
        section.title
    ) : null;
    var sectionMarkup = createElement(
        'div',
        { className: className },
        titleMarkup,
        createElement(
...
function Badge$1(_ref) {
    ...
    var className = classNames(styles$15.Badge, status && styles$15[variationName('status', status)], progress && styles$15[variationName('progress', progress)]);
    var pipMarkup = progress ? createElement(
        'span',
    ...
    var statusLabelMarkup = status ? createElement(
        VisuallyHidden$1,
        null,
...
function Banner$1(_ref) {
    ...
    var className = classNames(styles$16.Banner, status && styles$16[variationName('status', status)], onDismiss && styles$16.hasDismiss);
    var id = uniqueID();
    ...
    var actionMarkup = action ? createElement(
        'div',
    ...
    var dismissButton = onDismiss ? createElement(
        'div',
...
function TextContainer$1(_ref) {
    ...
    var className = classNames(styles$17.TextContainer, spacing && styles$17[variationName('spacing', spacing)]);
    return createElement(
        'div',
        { className: className },
        children
...
function CalloutCard$1(_ref) {
  ...
  var buttonMarkup = secondaryActionMarkup ? createElement(
    ButtonGroup$1,
    null,
    primaryActionMarkup,
    secondaryActionMarkup
...
function Choice$1(_ref) {
    ...
    var className = classNames(styles$20.Choice, labelHidden && styles$20.labelHidden);
    var labelMarkup = createElement(
        'label',
    ...
    var helpTextMarkup = helpText ? createElement(
        'div',
        { className: styles$20.HelpText, id: helpTextID(id) },
        helpText
    ) : null;
    var errorMarkup = typeof error === 'string' ? createElement(
        'div',
    ...
    var descriptionMarkup = helpTextMarkup || errorMarkup ? createElement(
        'div',
...
var getUniqueID = createUniqueIDFactory('Checkbox');
function Checkbox$1(_ref) {
    ...
    var wrapperClassName = classNames(styles$21.Checkbox, error && styles$21.error);
    ...
    var inputClassName = classNames(styles$21.Input, isChecked && styles$21['Input-checked'], isIndeterminate && styles$21['Input-indeterminate']);
    return createElement(
        Choice$1,
...
var getUniqueID$2 = createUniqueIDFactory('RadioButton');
...
var getUniqueID$1 = createUniqueIDFactory('ChoiceList');
function ChoiceList$1(_ref) {
    ...
    var className = classNames(styles$23.ChoiceList, titleHidden && styles$23.titleHidden);
    var titleMarkup = title ? createElement(
        'legend',
...
var Collapsible$1 = function (_React$Component) {
    ...
    _createClass(Collapsible, [{
        ...
        value: function render() {
            ...
            var wrapperClassName = classNames(styles$24.Collapsible, open && styles$24.open, animating && styles$24.animating);
...
var EventListener$1 = function (_React$PureComponent) {
    ...
    _createClass(EventListener, [{
        ...
        value: function attachListener() {
            ...
            addEventListener(window, event, handler, { capture: capture, passive: passive });
        }
    }, {
        key: 'detachListener',
...
var Slidable = function (_React$PureComponent) {
    ...
    _createClass(Slidable, [{
        ...
        value: function render() {
            ...
            var moveListener = dragging ? createElement(EventListener$1, { event: 'mousemove', handler: this.handleMove }) : null;
            var touchMoveListener = dragging ? createElement(EventListener$1, { event: 'touchmove', handler: this.handleMove }) : null;
            var endDragListener = dragging ? createElement(EventListener$1, { event: 'mouseup', handler: this.handleDragEnd }) : null;
            var touchEndListener = dragging ? createElement(EventListener$1, { event: 'touchend', handler: this.handleDragEnd }) : null;
            var touchCancelListener = dragging ? createElement(EventListener$1, { event: 'touchcancel', handler: this.handleDragEnd }) : null;
            return createElement(
                'div',
...
var HuePicker = function (_React$PureComponent) {
    ...
    _createClass(HuePicker, [{
        ...
        value: function render() {
            ...
            var draggerY = clamp(offset, 0, sliderHeight);
            return createElement(
                'div',
    ...
    _createClass(AlphaPicker, [{
        ...
        value: function render() {
            ...
            return createElement(
                ...
                createElement('div', { className: styles$25.ColorLayer, style: { background: background } }),
                createElement(Slidable, { draggerY: draggerY, draggerX: 0, onChange: this.handleChange, onDraggerHeight: this.setDraggerHeight })
            );
        }
    }, {
...
var ColorPicker$1 = function (_React$PureComponent) {
    ...
    _createClass(ColorPicker, [{
        ...
        value: function render() {
            ...
            var alphaSliderMarkup = allowAlpha ? createElement(AlphaPicker, { alpha: alpha, color: color, onChange: this.handleAlphaChange }) : null;
            return createElement(
                'div',
...
var Item$4 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$26.Item, focused && styles$26['Item-focused'], position === Position.Primary ? styles$26['Item-primary'] : styles$26['Item-connection']);
            return createElement(
                'div',
...
__decorate([autobind], Item$4.prototype, "handleBlur", null);
__decorate([autobind], Item$4.prototype, "handleFocus", null);
...
function Connected$1(_ref) {
    ...
    var leftConnectionMarkup = left ? createElement(
        Item$4,
        { position: Position.Left },
        left
    ) : null;
    var rightConnectionMarkup = right ? createElement(
        Item$4,
...
var Day = function (_React$PureComponent) {
    ...
    _createClass(Day, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$27.Day, selected && styles$27['Day-selected'], disabled && styles$27['Day-disabled'], today && styles$27['Day-today'], (inRange || inHoveringRange) && !disabled && styles$27['Day-inRange']);
            var date = day.getDate();
            var tabIndex = (focused || selected || today || date === 1) && !disabled ? 0 : -1;
            var ariaLabel = ['' + (today ? 'Today ' : ''), Months[day.getMonth()] + ' ', date + ' ', '' + day.getFullYear()].join('');
            return createElement(
                'button',
...
function Weekday(_ref) {
    ...
    var className = classNames(styles$27.Weekday, current && styles$27['Weekday-current']);
    return createElement(
        'div',
...
function Month(_ref) {
    var focusedDate = _ref.focusedDate,
        ...
        onFocus = _ref$onFocus === undefined ? noop : _ref$onFocus,
        month = _ref.month,
        year = _ref.year;
    ...
    var className = classNames(styles$27.Title, current && styles$27['Month-current']);
    var weeks = getWeeksForMonth(month, year);
    var weekdays = WEEKDAYS.map(function (weekday) {
        return createElement(Weekday, { key: weekday, title: abbreviationForWeekday(weekday), current: current && new Date().getDay() === weekday, label: weekday });
    });
...
function DescriptionList$1(_ref) {
    ...
    var terms = items.reduce(function (allTerms, _ref2) {
        ...
        return [].concat(_toConsumableArray(allTerms), [createElement(
            'dt',
...
function DisplayText$1(_ref) {
    ...
    var className = classNames(styles$29.DisplayText, size && styles$29[variationName('size', size)]);
    return createElement(
        Element,
        { className: className },
        children
...
var EmptyState$1 = function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$30.EmptyState, imageContained && styles$30.imageContained);
      var imageMarkup = largeImage ? createElement(Image$1, { alt: '', role: 'presentation', className: styles$30.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : createElement(Image$1, { role: 'presentation', alt: '', className: styles$30.Image, source: image });
      var secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
      return createElement(
        'div',
        { className: className },
...
var getUniqueID$3 = createUniqueIDFactory('FormLayoutGroup');
function Group(_ref) {
    var children = _ref.children,
    ...
    var className = classNames(condensed && styles$32.condensed);
    ...
    var itemsMarkup = Children.map(children, function (child) {
        return wrapWithComponent(child, Item$6);
    });
    return createElement(
        'div',
...
function wrapChildren(child, index) {
    ...
    var props = { key: index };
    return wrapWithComponent(child, Item$6, props);
}
...
function Label$1(_ref) {
    ...
    var className = classNames(styles$34.Label, hidden && styles$34.hidden);
    return createElement(
        'div',
        { className: className },
        createElement(
...
function Labelled$1(_a) {
    ...
    var className = classNames(labelHidden && styles$35.hidden);
    ...
    var labelMarkup = label ? createElement(
        'div',
...
function Section$2(_ref) {
    ...
    var className = classNames(styles$36.Section, secondary && styles$36['Section-secondary'], fullWidth && styles$36['Section-fullWidth']);
    return createElement(
        'div',
        { className: className },
        children
...
function AnnotatedSection(props) {
  ...
  var wrappedDescription = typeof description === 'string' ? createElement(
    'p',
    null,
    description
  ) : description;
...
var ContentList = function (_React$PureComponent) {
    ...
    _createClass(ContentList, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$38.List, type && styles$38[variationName('type', type)]);
...
function Pagination$1(_ref) {
  ...
  var className = classNames$1(styles$40.Pagination, plain && styles$40.plain);
  var previousButton = previousURL ? createElement(
    UnstyledLink$1,
  ...
  var nextButton = nextURL ? createElement(
    UnstyledLink$1,
...
var Scrollable$1 = function (_React$Component) {
    ...
    _createClass(Scrollable, [{
        ...
        value: function render() {
            ...
            var finalClassName = classNames(className, styles$41.Scrollable, vertical && styles$41.vertical, horizontal && styles$41.horizontal, topShadow && styles$41.hasTopShadow, bottomShadow && styles$41.hasBottomShadow);
            return createElement(
                'div',
    ...
    _createClass(PositionedOverlay, [{
        ...
        value: function handleMeasurement() {
            ...
            this.setState({
                ...
                var activatorRect = getRectForNode(activator);
                var currentOverlayRect = getRectForNode(_this2.overlay);
...
function Pane(_ref) {
    ...
    var className = classNames(styles$43.Pane, fixed && styles$43['Pane-fixed']);
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function componentDidUpdate(_ref) {
            ...
            write(function () {
                ...
                var focusableChild = findFirstFocusableNode(_this2.contentNode);
        ...
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = classNames(styles$43.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$43.positionedAbove, fullWidth && styles$43.fullWidth, measuring && styles$43.measuring);
            this.transitionStatus = transitionStatus;
            var tipMarkup = !measuring ? createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$43.Tip }) : null;
            ...
            return createElement(
                ...
                tipMarkup,
                createElement('div', { className: styles$43.FocusTracker, tabIndex: 0, onFocus: this.handleFocusFirstItem }),
                createElement(
                    'div',
                    { className: styles$43.Wrapper },
                    content
                ),
                createElement('div', { className: styles$43.FocusTracker, tabIndex: 0, onFocus: this.handleFocusLastItem })
            );
        }
    }, {
        key: 'setContentNode',
        ...
        value: function handleClick(event) {
            ...
            var isDescendant = contentNode != null && nodeContainsDescendant(contentNode, target);
...
var getUniqueID$4 = createUniqueIDFactory('Popover');
...
function Action(_ref) {
    ...
    var contentMarkup = iconMarkup || disclosureIconMarkup ? createElement(
        'span',
    ...
    var className = classNames$1(styles$44.Action, disabled && styles$44.disabled, icon && children == null && styles$44.iconOnly);
    return createElement(
        'button',
...
var Header$1 = function (_React$PureComponent) {
    ...
    _createClass(Header, [{
        ...
        value: function render() {
            ...
            var breadcrumbMarkup = breadcrumbs.length > 0 ? createElement(Breadcrumbs$1, { breadcrumbs: breadcrumbs }) : null;
            var primaryActionMarkup = primaryAction ? createElement(
                'div',
                { className: styles$44.PrimaryAction },
                buttonsFrom(primaryAction, { primary: true })
            ) : null;
            var paginationMarkup = pagination ? createElement(
                'div',
            ...
            var actionsMarkup = createElement(
                'div',
                { className: styles$44.Actions },
                primaryActionMarkup,
                nonPrimaryActionsMarkup
            );
            var navigationMarkup = breadcrumbMarkup || paginationMarkup ? createElement(
                'div',
                { className: styles$44.Navigation },
                breadcrumbMarkup,
                paginationMarkup
            ) : null;
            var titleMarkup = createElement(
                'div',
        ...
        value: function renderSecondaryActions() {
            ...
            var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref) {
                ...
                return createElement(
                    ...
                    createElement(
                        Popover$2,
                        { key: title, active: title === openActionGroup, onClose: _this2.handleActionGroupClose.bind(_this2, title), activator: createElement(
                                Action,
                                { disclosure: true, icon: icon, onAction: _this2.handleActionGroupOpen.bind(_this2, title) },
                                title
                            ) },
                        createElement(ActionList$1, { items: actions, onActionAnyItem: _this2.handleActionGroupClose.bind(_this2, title) }),
                        detailsMarkup
                    )
                );
            }) : null;
            var rollupMarkup = this.hasRollup ? createElement(
                'div',
...
var Page$1 = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$44.Page, fullWidth && styles$44.fullWidth, singleColumn && styles$44.singleColumn);
            var headerMarkup = this.context.easdk || !this.hasHeaderContent() ? null : createElement(Header$1, rest);
            return createElement(
                'div',
                { className: className },
                headerMarkup,
...
function PageActions$1(_ref) {
    ...
    var secondaryActionsMarkup = secondaryActions ? createElement(
        ButtonGroup$1,
        null,
...
function Thumbnail$1(_ref) {
    ...
    var className = classNames(styles$46.Thumbnail, size && styles$46[variationName('size', size)]);
    return createElement(
        'span',
        { className: className },
...
var getUniqueID$5 = createUniqueIDFactory('ResourceListItem');
...
var Item$8 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var attributeTwoMarkup = attributeTwo ? createElement(
                'div',
                { className: styles$47.AttributeTwo },
                attributeTwo
            ) : null;
            var badgeMarkup = badges ? createElement(
                'div',
                { className: styles$47.Badge },
                badges.map(renderBadge)
            ) : null;
            var attributeThreeMarkup = attributeThree ? createElement(
                'div',
                { className: styles$47.AttributeThree },
                attributeThree
            ) : null;
            var exceptionsMarkup = exceptions ? createElement(
                'ul',
            ...
            var className = classNames(styles$47.Item, url && styles$47['Item-link'], focused && styles$47['Item-focused'], persistActions && styles$47['Item-persistActions'], mediaType && styles$47[variationName('Item-media', mediaType)], mediaSize && styles$47[variationName('Item-size', mediaSize)]);
            ...
            var containerMarkup = createElement(
                'div',
...
__decorate([autobind], Item$8.prototype, "setNode", null);
__decorate([autobind], Item$8.prototype, "handleFocus", null);
__decorate([autobind], Item$8.prototype, "handleBlur", null);
__decorate([autobind], Item$8.prototype, "mouseEnter", null);
__decorate([autobind], Item$8.prototype, "mouseLeave", null);
__decorate([autobind], Item$8.prototype, "handleClick", null);
__decorate([autobind], Item$8.prototype, "handleCloseRequest", null);
...
function renderException(exception, index) {
    ...
    var className = classNames(styles$47.ExceptionItem, status && styles$47[variationName('ExceptionItem-status', status)]);
    var titleMarkup = title != null ? createElement(
        'div',
        { className: styles$47.Title },
        title
    ) : null;
    var descriptionMarkup = description != null ? createElement(
        'div',
...
var getUniqueID$6 = createUniqueIDFactory('Select');
function Select$1(_ref) {
    ...
    var className = classNames(styles$48.Select, error && styles$48.error, disabled && styles$48.disabled, isPlaceholder && styles$48.placeholder);
    ...
    var placeholderOption = isPlaceholder ? createElement('option', { label: placeholder, value: PLACEHOLDER_VALUE, disabled: true, hidden: true }) : null;
...
var Item$10 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$49.Item);
            return createElement(
                'li',
                { role: 'presentation' },
                createElement(
...
__decorate([autobind], Item$10.prototype, "setFocusedNode", null);
    ...
    _createClass(List, [{
        ...
        value: function handleKeypress(event) {
            var _props$onKeyPress = this.props.onKeyPress,
                onKeyPress = _props$onKeyPress === undefined ? noop : _props$onKeyPress;
...
__decorate([autobind], List$2.prototype, "handleKeypress", null);
...
var Tab = function (_React$PureComponent) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$49.Tab, selected && styles$49['Tab-selected']);
            var tabIndex = void 0;
...
var TabMeasurer = function (_React$PureComponent) {
    ...
    _createClass(TabMeasurer, [{
        ...
        value: function render() {
            ...
            var classname = classNames(styles$49.Tabs, styles$49.TabMeasurer);
            return createElement(
                'div',
        ...
        value: function handleMeasurement() {
            ...
            var hiddenTabNodes = findDOMNode(this).children;
...
var Tabs$1 = function (_React$PureComponent) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var panelMarkup = children ? createElement(
                Panel,
            ...
            var classname = classNames(styles$49.Tabs, fitted && styles$49.fitted, disclosureActivatorVisible && styles$49.fillSpace);
            var disclosureTabClassName = classNames(styles$49.DisclosureTab, disclosureActivatorVisible && styles$49['DisclosureTab-visible']);
            var activator = createElement(
                'button',
                ...
                createElement(
                    ...
                    createElement(
                        ...
                        createElement(
                            ...
                            createElement(List$2, { focusIndex: hiddenTabs.indexOf(tabToFocus), disclosureTabs: disclosureTabs, onClick: this.handleTabClick, onKeyPress: this.handleKeyPress })
                        )
                    )
                ),
        ...
        value: function handleTabClick(id) {
            var _props4 = this.props,
                ...
                onSelect = _props4$onSelect === undefined ? noop : _props4$onSelect;
...
var Resizer = function (_React$PureComponent) {
    ...
    _createClass(Resizer, [{
        ...
        value: function render() {
            ...
            var minimumLinesMarkup = minimumLines ? createElement('div', { ref: this.setMinimumLinesNode, className: styles$51.DummyInput, dangerouslySetInnerHTML: { __html: getContentsForMinimumLines(minimumLines) } }) : null;
            return createElement(
                'div',
...
var getUniqueID$7 = createUniqueIDFactory('TextField');
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            var _a = this.props,
                ...
                focused = _a.focused,
                rest = __rest(_a, ["id", "value", "placeholder", "disabled", "readOnly", "autoFocus", "type", "name", "error", "multiline", "connectedRight", "connectedLeft", "label", "labelAction", "labelHidden", "helpText", "prefix", "suffix", "onFocus", "onBlur", "autoComplete", "focused"]);var height = this.state.height;

            var className = classNames(styles$51.TextField, Boolean(value) && styles$51.hasValue, disabled && styles$51.disabled, readOnly && styles$51.readOnly, error && styles$51.error, multiline && styles$51.multiline, this.state.focus && styles$51.focus);
            var prefixMarkup = prefix ? createElement(
                'div',
                { className: styles$51.Prefix, id: id + 'Prefix' },
                prefix
            ) : null;
            var suffixMarkup = suffix ? createElement(
                'div',
                { className: styles$51.Suffix, id: id + 'Suffix' },
                suffix
            ) : null;
            var spinnerMarkup = type === 'number' && !disabled ? createElement(Spinner$2, { onChange: this.handleNumberChange }) : null;
            var style = multiline && height ? { height: height } : null;
            var resizer = multiline != null ? createElement(Resizer, { contents: value || placeholder, currentHeight: height, minimumLines: typeof multiline === 'number' ? multiline : 1, onHeightChange: this.handleExpandingResize }) : null;
            var describedBy = [];
            if (error && typeof error === 'string') {
                describedBy.push(errorID$1(id));
            }
            ...
            var input = createElement(multiline ? 'textarea' : 'input', Object.assign({}, rest, { name: name,
                id: id,
                type: type,
                disabled: disabled,
                readOnly: readOnly,
...
var TooltipOverlay = function (_React$PureComponent) {
    ...
    _createClass(TooltipOverlay, [{
        ...
        value: function renderTooltip(overlayDetails) {
            ...
            var containerClassName = classNames(styles$52.Tooltip, light && styles$52.light, measuring && styles$52.measuring, positioning === 'above' && styles$52.positionedAbove);
            var contentStyles = measuring ? undefined : { maxHeight: desiredHeight };
            var tipMarkup = !measuring ? createElement('div', { style: tipStyle, className: styles$52.Tip }) : null;
            return createElement(
                'div',
...
var getUniqueID$8 = createUniqueIDFactory('TooltipContent');
...
function SkeletonDisplayText$1(_ref) {
    ...
    var className = classNames(styles$53.DisplayText, size && styles$53[variationName('size', size)]);
...
var SkeletonPage = function (_React$PureComponent) {
    ...
    _createClass(SkeletonPage, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$55.Page, fullWidth && styles$55.fullWidth);
            var headerClassName = classNames(styles$55.Header, secondaryActions && styles$55['Header-hasSecondaryActions']);
            ...
            var headerMarkup = !this.context.easdk ? createElement(
                'div',
...
function renderTitle(title) {
    var titleContent = title === '' ? createElement(SkeletonDisplayText$1, { size: 'large' }) : createElement(
        DisplayText$1,
        { size: 'large', element: 'h1' },
        title
    );
...
function ProgressBar$1(_ref) {
    ...
    var className = classNames(styles$56.ProgressBar, size && styles$56[variationName('size', size)]);
