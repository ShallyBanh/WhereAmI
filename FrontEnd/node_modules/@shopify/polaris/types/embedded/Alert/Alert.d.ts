...
export declare class Alert extends React.PureComponent<Props & WithEASDKProps, never> {
...
declare const _default: (React.ComponentClass<Props> & typeof Alert) | (React.StatelessComponent<Props> & typeof Alert);
